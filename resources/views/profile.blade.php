                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img src="{{asset('admin/assets/images/users/9.jpg')}}" alt="user" class="rounded-circle" width="31">
                            </a>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Profile kuuuuu</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="{{asset('admin/assets/images/users/9.jpg')}}" class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10">{{$data_profile->name}}</h4>
                                    <h6 class="card-subtitle">Manager NF Corporation -belum ada dlm column db</h6>
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">                                
                                ...
                                <div class="tab-pane fade" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material" method ="post" action="/Profile/{{$data_profile->id}}/edit">
                                            {{csrf_field()}}
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" placeholder="belum ada column dalam db" class="form-control form-control-line" name="designation" value="{{$data_profile->designation}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                        ...
                        <li>
                            <div class="message-center chat-scroll">
                                ...
                                <a href="javascript:void(0)" class="message-item" id='chat_user_8' data-user-id='8'>
                                    <span class="user-img"> <img src="{{asset('admin/assets/images/users/9.jpg')}}" alt="user" class="rounded-circle"> <span class="profile-status offline pull-right"></span> </span>
                                    <span class="mail-contnet">
